...
public class EclipsePluginImpl extends EObjectImpl implements EclipsePlugin {
	...
	protected EClass eStaticClass() {
		return SherlockPackage.Literals.ECLIPSE_PLUGIN;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SherlockPackage.ECLIPSE_PLUGIN__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SherlockPackage.ECLIPSE_PLUGIN__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SherlockPackage.ECLIPSE_PLUGIN__VERSION, oldVersion, version));
	}
	...
	public void setProvider(String newProvider) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SherlockPackage.ECLIPSE_PLUGIN__PROVIDER, oldProvider, provider));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SherlockPackage.ECLIPSE_PLUGIN__ID:
				return getId();
			case SherlockPackage.ECLIPSE_PLUGIN__NAME:
				return getName();
			case SherlockPackage.ECLIPSE_PLUGIN__VERSION:
				return getVersion();
			case SherlockPackage.ECLIPSE_PLUGIN__PROVIDER:
				return getProvider();
		}
