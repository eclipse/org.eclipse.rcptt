...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Trace Data</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class TraceDataImpl extends EObjectImpl implements TraceData {
	...
	public void setMessage(String newMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReportPackage.TRACE_DATA__MESSAGE, oldMessage, message));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReportPackage.TRACE_DATA__MESSAGE:
				return getMessage();
		}
