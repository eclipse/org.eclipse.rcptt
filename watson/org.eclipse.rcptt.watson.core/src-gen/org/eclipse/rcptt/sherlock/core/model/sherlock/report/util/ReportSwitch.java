...
public class ReportSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ReportPackage.SNAPHOT: {
				Snaphot snaphot = (Snaphot)theEObject;
				T result = caseSnaphot(snaphot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ReportPackage.SCREENSHOT: {
				Screenshot screenshot = (Screenshot)theEObject;
				T result = caseScreenshot(screenshot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReportPackage.TRACE_DATA: {
				TraceData traceData = (TraceData)theEObject;
				T result = caseTraceData(traceData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ReportPackage.LOGGING_DATA: {
				LoggingData loggingData = (LoggingData)theEObject;
				T result = caseLoggingData(loggingData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Snaphot</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Snaphot</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Logging Data</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Logging Data</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLoggingData(LoggingData object) {
		return null;
	}
