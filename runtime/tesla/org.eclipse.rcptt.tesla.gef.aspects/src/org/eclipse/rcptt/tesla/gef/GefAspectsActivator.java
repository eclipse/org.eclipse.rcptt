 ...
 */
public class GefAspectsActivator extends Plugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.rcptt.tesla.gef.aspects";

	// The shared instance
	private static GefAspectsActivator plugin;

	/**
	 * The constructor
	 */
	public GefAspectsActivator() {
	}
	 ...
	 */
	public static GefAspectsActivator getDefault() {
		return plugin;
	}
