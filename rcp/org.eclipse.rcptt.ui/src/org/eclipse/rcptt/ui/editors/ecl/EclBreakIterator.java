 ...
 * 
 */
public class EclBreakIterator extends BreakIterator {
	...
	static final class LineDelimiter extends Run {
		...
		/*
		 * @see
		 * org.eclipse.jdt.internal.ui.text.JavaBreakIterator.Run#consume(char)
		 */
		@Override
		protected boolean consume(char ch) {
	...
	static final class Identifier extends Run {
		/*
		 * @see
		 * org.eclipse.jdt.internal.ui.text.JavaBreakIterator.Run#isValid(char)
		 */
		@Override
		protected boolean isValid(char ch) {
	...
	static final class CamelCaseIdentifier extends Run {
		...
		/*
		 * @see
		 * org.eclipse.jdt.internal.ui.text.JavaBreakIterator.Run#consumes(char)
		 */
		@Override
		protected boolean consume(char ch) {
			int kind = getKind(ch);
