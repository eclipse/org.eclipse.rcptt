...
public class WizardProjectsImportPage extends BaseProjectsImportPage {
	...
	public WizardProjectsImportPage(WorkspaceContext context) {
		this(context, null);
	}
	 ...
	 * @since 3.5
	 */
	public WizardProjectsImportPage(WorkspaceContext context, String initialPath) {
		super(initialPath);
	...
	protected boolean createExistingProject(final ProjectRecord record,
		...
		if (record.projectArchiveFile != null) {
			...
			context.getContent().getProjects().add(project);
	...
	protected boolean isProjectExists(String projectName) {
		...
		for (WSProject project : context.getContent().getProjects()) {
