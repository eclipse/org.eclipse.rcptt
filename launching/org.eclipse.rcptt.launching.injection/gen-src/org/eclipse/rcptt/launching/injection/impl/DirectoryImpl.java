 ...
 * <ul>
 *   <li>{@link org.eclipse.rcptt.launching.injection.impl.DirectoryImpl#getPath <em>Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DirectoryImpl extends EntryImpl implements Directory {
	...
	protected EClass eStaticClass() {
		return InjectionPackage.Literals.DIRECTORY;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InjectionPackage.DIRECTORY__PATH, oldPath, path));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InjectionPackage.DIRECTORY__PATH:
				return getPath();
		}
