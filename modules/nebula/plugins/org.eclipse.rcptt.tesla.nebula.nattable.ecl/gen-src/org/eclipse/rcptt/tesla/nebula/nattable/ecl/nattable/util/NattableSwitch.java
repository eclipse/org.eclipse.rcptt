...
public class NattableSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NattablePackage.NEBULA_NAT_TABLE: {
				NebulaNatTable nebulaNatTable = (NebulaNatTable)theEObject;
				T result = caseNebulaNatTable(nebulaNatTable);
				if (result == null) result = caseControl(nebulaNatTable);
				if (result == null) result = caseWidget(nebulaNatTable);
				if (result == null) result = casePropertyNodeList(nebulaNatTable);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Nebula Nat Table</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Nebula Nat Table</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNebulaNatTable(NebulaNatTable object) {
		return null;
	}
