...
public class SWTModelMapper {
	 ...
	 * style.setUnderline("single"); //$NON-NLS-1$
	 * break;
	 * case SWT.UNDERLINE_DOUBLE:
	 * style.setUnderline("double"); //$NON-NLS-1$
	 * break;
	 * case SWT.UNDERLINE_SQUIGGLE:
	 * style.setUnderline("squiggle"); //$NON-NLS-1$
	 * break;
	 * case SWT.UNDERLINE_ERROR:
	 * style.setUnderline("error"); //$NON-NLS-1$
	 * break;
	 * case SWT.UNDERLINE_LINK:
	 * style.setUnderline("link"); //$NON-NLS-1$
	 * break;
	 * }
	 ...
	 * style.setBorderStyle("solid"); //$NON-NLS-1$
	 * break;
	 * case SWT.BORDER_DOT:
	 * style.setBorderStyle("dot"); //$NON-NLS-1$
	 * break;
	 * case SWT.BORDER_DASH:
	 * style.setBorderStyle("dash"); //$NON-NLS-1$
	 * break;
	 * }
