 ...
 * <ul>
 *   <li>{@link org.eclipse.rcptt.ecl.example.view.impl.ShowViewImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ShowViewImpl extends CommandImpl implements ShowView {
	...
	protected EClass eStaticClass() {
		return ViewPackage.Literals.SHOW_VIEW;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SHOW_VIEW__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ViewPackage.SHOW_VIEW__ID:
				return getId();
		}
