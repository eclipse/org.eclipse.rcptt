...
public class ViewFactoryImpl extends EFactoryImpl implements ViewFactory {
	...
	public static ViewFactory init() {
		try {
			ViewFactory theViewFactory = (ViewFactory)EPackage.Registry.INSTANCE.getEFactory("http://eclipse.org/ecl/examples/view.ecore"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ViewPackage.SHOW_VIEWS: return createShowViews();
			case ViewPackage.VIEW: return createView();
			case ViewPackage.SHOW_VIEW: return createShowView();
			default:
