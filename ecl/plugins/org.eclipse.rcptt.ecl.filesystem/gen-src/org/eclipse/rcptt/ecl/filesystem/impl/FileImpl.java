 ...
 * <ul>
 *   <li>{@link org.eclipse.rcptt.ecl.filesystem.impl.FileImpl#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileImpl extends EObjectImpl implements File {
	...
	public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FilesystemPackage.FILE__URI, oldUri, uri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FilesystemPackage.FILE__URI:
				return getUri();
		}
