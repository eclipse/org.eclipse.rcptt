...
public class FilesystemSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FilesystemPackage.COPY_FILE: {
				CopyFile copyFile = (CopyFile)theEObject;
				T result = caseCopyFile(copyFile);
				if (result == null) result = caseCommand(copyFile);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Copy File</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Copy File</em>'.
