 ...
 * @generated
 */
public class LaunchImpl extends CommandImpl implements Launch {
	/**
	...
	protected EClass eStaticClass() {
		return CommandsPackage.Literals.LAUNCH;
	}
	...
	public void setMode(String newMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandsPackage.LAUNCH__MODE, oldMode, mode));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandsPackage.LAUNCH__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommandsPackage.LAUNCH__MODE:
				return getMode();
			case CommandsPackage.LAUNCH__NAME:
				return getName();
		}
