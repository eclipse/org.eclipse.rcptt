 ...
 * <ul>
 *   <li>{@link org.eclipse.rcptt.ecl.platform.objects.impl.LaunchConfigurationImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LaunchConfigurationImpl extends EObjectImpl implements LaunchConfiguration {
	...
	protected EClass eStaticClass() {
		return ObjectsPackage.Literals.LAUNCH_CONFIGURATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ObjectsPackage.LAUNCH_CONFIGURATION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ObjectsPackage.LAUNCH_CONFIGURATION__NAME:
				return getName();
		}
