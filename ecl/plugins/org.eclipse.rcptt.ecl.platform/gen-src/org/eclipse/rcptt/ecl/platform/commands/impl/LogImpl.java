 ...
 * @generated
 */
public class LogImpl extends CommandImpl implements Log {
	/**
	 ...
	 * @ordered
	 */
	protected static final String PLUGIN_EDEFAULT = "org.eclipse.rcptt.ecl.platform";
	...
	protected EClass eStaticClass() {
		return CommandsPackage.Literals.LOG;
	}
	...
	public void setPlugin(String newPlugin) {
		...
		plugin = newPlugin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandsPackage.LOG__PLUGIN, oldPlugin, plugin));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommandsPackage.LOG__MESSAGE:
				return getMessage();
			case CommandsPackage.LOG__SEVERITY:
				return getSeverity();
			case CommandsPackage.LOG__PLUGIN:
				return getPlugin();
		}
