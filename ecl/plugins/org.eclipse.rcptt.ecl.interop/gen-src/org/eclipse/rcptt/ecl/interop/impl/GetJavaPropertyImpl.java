...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Java Property</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class GetJavaPropertyImpl extends CommandImpl implements GetJavaProperty {
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InteropPackage.GET_JAVA_PROPERTY__KEY, oldKey, key));
	}
	...
	public void setDefault(String newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InteropPackage.GET_JAVA_PROPERTY__DEFAULT, oldDefault, default_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InteropPackage.GET_JAVA_PROPERTY__KEY:
				return getKey();
			case InteropPackage.GET_JAVA_PROPERTY__DEFAULT:
				return getDefault();
		}
