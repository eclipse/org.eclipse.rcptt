 ...
 * <ul>
 *   <li>{@link org.eclipse.rcptt.ecl.debug.commands.impl.ServerInfoImpl#getPort <em>Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServerInfoImpl extends EObjectImpl implements ServerInfo {
	...
	public void setPort(int newPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandsPackage.SERVER_INFO__PORT, oldPort, port));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommandsPackage.SERVER_INFO__PORT:
				return getPort();
		}
