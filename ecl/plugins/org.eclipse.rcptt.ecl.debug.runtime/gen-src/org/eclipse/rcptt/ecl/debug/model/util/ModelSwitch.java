...
public class ModelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.BREAKPOINT_EVENT: {
				BreakpointEvent breakpointEvent = (BreakpointEvent)theEObject;
				T result = caseBreakpointEvent(breakpointEvent);
				if (result == null) result = caseEvent(breakpointEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.STACK_EVENT: {
				StackEvent stackEvent = (StackEvent)theEObject;
				T result = caseStackEvent(stackEvent);
				if (result == null) result = caseEvent(stackEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.STACK_FRAME: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Breakpoint Event</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Breakpoint Event</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBreakpointEvent(BreakpointEvent object) {
		return null;
	}
