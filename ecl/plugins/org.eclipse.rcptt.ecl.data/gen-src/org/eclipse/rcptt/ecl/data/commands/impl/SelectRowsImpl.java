...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Select Rows</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class SelectRowsImpl extends CommandImpl implements SelectRows {
	/**
	...
	protected EClass eStaticClass() {
		return CommandsPackage.Literals.SELECT_ROWS;
	}
		...
		if (table != null && table.eIsProxy()) {
			...
			if (table != oldTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CommandsPackage.SELECT_ROWS__TABLE, oldTable, table));
			}
		}
		return table;
	}
	...
	public void setTable(Table newTable) {
		...
		table = newTable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandsPackage.SELECT_ROWS__TABLE, oldTable, table));
	}
	...
	public void setColumn(String newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandsPackage.SELECT_ROWS__COLUMN, oldColumn, column));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandsPackage.SELECT_ROWS__VALUE, oldValue, value));
	}
	...
	public void setMatch(RowMatchMode newMatch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandsPackage.SELECT_ROWS__MATCH, oldMatch, match));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommandsPackage.SELECT_ROWS__TABLE:
				if (resolve) return getTable();
				return basicGetTable();
			case CommandsPackage.SELECT_ROWS__COLUMN:
				return getColumn();
			case CommandsPackage.SELECT_ROWS__VALUE:
				return getValue();
			case CommandsPackage.SELECT_ROWS__MATCH:
				return getMatch();
		}
