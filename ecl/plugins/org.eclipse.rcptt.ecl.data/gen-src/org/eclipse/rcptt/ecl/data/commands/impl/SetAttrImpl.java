...
public class SetAttrImpl extends CommandImpl implements SetAttr {
	...
	protected EClass eStaticClass() {
		return CommandsPackage.Literals.SET_ATTR;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandsPackage.SET_ATTR__NAME, oldName, name));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommandsPackage.SET_ATTR__VALUE, oldValue, value));
	}
