...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>As Table Data</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class AsTableDataImpl extends CommandImpl implements AsTableData {
	/**
	...
	protected EClass eStaticClass() {
		return CommandsPackage.Literals.AS_TABLE_DATA;
	}
	...
	public EList<EObject> getInput() {
		if (input == null) {
			input = new EObjectResolvingEList<EObject>(EObject.class, this, CommandsPackage.AS_TABLE_DATA__INPUT);
		}
		return input;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommandsPackage.AS_TABLE_DATA__INPUT:
				return getInput();
		}
