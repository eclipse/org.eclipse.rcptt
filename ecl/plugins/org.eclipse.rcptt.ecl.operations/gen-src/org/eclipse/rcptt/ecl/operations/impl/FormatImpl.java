 ...
 * @generated
 */
public class FormatImpl extends CommandImpl implements Format {
	/**
	...
	protected EClass eStaticClass() {
		return OperationsPackage.Literals.FORMAT;
	}
	...
	public void setFormat(String newFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.FORMAT__FORMAT, oldFormat, format));
	}
	...
	public EList<EObject> getArgs() {
		if (args == null) {
			args = new EObjectResolvingEList<EObject>(EObject.class, this, OperationsPackage.FORMAT__ARGS);
		}
		return args;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.FORMAT__FORMAT:
				return getFormat();
			case OperationsPackage.FORMAT__ARGS:
				return getArgs();
		}
