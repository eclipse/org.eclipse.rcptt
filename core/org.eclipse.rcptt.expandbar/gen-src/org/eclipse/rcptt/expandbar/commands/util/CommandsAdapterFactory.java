...
public class CommandsAdapterFactory extends AdapterFactoryImpl {
	...
	protected CommandsSwitch<Adapter> modelSwitch =
		new CommandsSwitch<Adapter>() {
			@Override
			public Adapter caseGetExpandBar(GetExpandBar object) {
				return createGetExpandBarAdapter();
			}
			@Override
			public Adapter caseGetExpandItem(GetExpandItem object) {
				return createGetExpandItemAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.rcptt.expandbar.commands.GetExpandBar <em>Get Expand Bar</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGetExpandBarAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.rcptt.expandbar.commands.GetExpandItem <em>Get Expand Item</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGetExpandItemAdapter() {
		return null;
	}
