...
import org.eclipse.rcptt.core.ecl.context.*;
...
public class ContextFactoryImpl extends EFactoryImpl implements ContextFactory {
	...
	public static ContextFactory init() {
		try {
			ContextFactory theContextFactory = (ContextFactory)EPackage.Registry.INSTANCE.getEFactory("http://eclipse.org/rcptt/ctx/ecl"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ContextPackage.ECL_CONTEXT: return createEclContext();
			default:
	...
	public EclContext createEclContext() {
		EclContextImpl eclContext = new EclContextImpl();
		return eclContext;
	}
