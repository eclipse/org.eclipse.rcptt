...
public class LogAdapterFactory extends AdapterFactoryImpl {
	...
	protected LogSwitch<Adapter> modelSwitch =
		new LogSwitch<Adapter>() {
			@Override
			public Adapter caseLogEntryPredicate(LogEntryPredicate object) {
				return createLogEntryPredicateAdapter();
			}
			@Override
			public Adapter caseErrorLogVerification(ErrorLogVerification object) {
				return createErrorLogVerificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.rcptt.verifications.log.LogEntryPredicate <em>Entry Predicate</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.rcptt.verifications.log.ErrorLogVerification <em>Error Log Verification</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
