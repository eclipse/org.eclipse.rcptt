...
import org.eclipse.rcptt.verifications.text.*;
...
public class TextSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TextPackage.TEXT_VERIFICATION: {
				TextVerification textVerification = (TextVerification)theEObject;
				T result = caseTextVerification(textVerification);
				if (result == null) result = caseWidgetVerification(textVerification);
				if (result == null) result = caseVerification(textVerification);
				if (result == null) result = caseNamedElement(textVerification);
	 ...
	 * @generated
	 */
	public T caseTextVerification(TextVerification object) {
		return null;
	}
