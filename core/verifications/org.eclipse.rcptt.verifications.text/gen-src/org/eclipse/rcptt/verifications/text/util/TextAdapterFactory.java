...
public class TextAdapterFactory extends AdapterFactoryImpl {
	...
	protected TextSwitch<Adapter> modelSwitch =
		new TextSwitch<Adapter>() {
			@Override
			public Adapter caseTextVerification(TextVerification object) {
				return createTextVerificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.rcptt.verifications.text.TextVerification <em>Verification</em>}'.
	 * <!-- begin-user-doc -->
