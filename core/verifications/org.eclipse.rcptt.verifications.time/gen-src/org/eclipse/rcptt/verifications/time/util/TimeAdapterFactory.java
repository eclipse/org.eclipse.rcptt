...
public class TimeAdapterFactory extends AdapterFactoryImpl {
	...
	protected TimeSwitch<Adapter> modelSwitch =
		new TimeSwitch<Adapter>() {
			@Override
			public Adapter caseTimeVerification(TimeVerification object) {
				return createTimeVerificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.rcptt.verifications.time.TimeVerification <em>Verification</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTimeVerificationAdapter() {
		return null;
	}
