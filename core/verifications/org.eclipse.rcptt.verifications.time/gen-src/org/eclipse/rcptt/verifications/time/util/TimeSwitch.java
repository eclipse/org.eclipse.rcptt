 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.rcptt.verifications.time.TimePackage
 * @generated
 */
public class TimeSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TimePackage.TIME_VERIFICATION: {
				TimeVerification timeVerification = (TimeVerification)theEObject;
				T result = caseTimeVerification(timeVerification);
				if (result == null) result = caseVerification(timeVerification);
				if (result == null) result = caseNamedElement(timeVerification);
	 ...
	 * @generated
	 */
	public T caseTimeVerification(TimeVerification object) {
		return null;
	}
