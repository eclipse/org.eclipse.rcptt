...
public class WorkspaceVerificationIndexer implements IIndexer {

	public WorkspaceVerificationIndexer() {
	}
	...
	public void index(IIndexDocument document) {
		...
		try {
			...
			if (namedElement instanceof WorkspaceVerification) {
				WorkspaceVerification verificaion = (WorkspaceVerification) namedElement;

				WSRoot content = verificaion.getContent();
