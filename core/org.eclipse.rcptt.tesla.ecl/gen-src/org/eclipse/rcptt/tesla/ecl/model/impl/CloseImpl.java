 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.rcptt.tesla.ecl.model.impl.CloseImpl#getControl <em>Control</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CloseImpl extends CommandImpl implements Close {
	/**
	...
	protected EClass eStaticClass() {
		return TeslaPackage.Literals.CLOSE;
	}
		...
		if (control != null && control.eIsProxy()) {
			...
			if (control != oldControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TeslaPackage.CLOSE__CONTROL, oldControl, control));
			}
		}
		return control;
	}
	...
	public void setControl(ControlHandler newControl) {
		...
		control = newControl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.CLOSE__CONTROL, oldControl, control));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TeslaPackage.CLOSE__CONTROL:
