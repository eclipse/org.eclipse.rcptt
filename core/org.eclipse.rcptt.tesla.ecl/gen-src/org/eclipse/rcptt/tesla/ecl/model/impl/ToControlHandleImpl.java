...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>To Control Handle</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.rcptt.tesla.ecl.model.impl.ToControlHandleImpl#getWidget <em>Widget</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ToControlHandleImpl extends CommandImpl implements ToControlHandle {
	...
	public void setWidget(Object newWidget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.TO_CONTROL_HANDLE__WIDGET, oldWidget, widget));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TeslaPackage.TO_CONTROL_HANDLE__WIDGET:
				return getWidget();
		}
