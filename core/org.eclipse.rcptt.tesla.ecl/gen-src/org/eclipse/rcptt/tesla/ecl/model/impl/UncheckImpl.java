 ...
 * <ul>
 *   <li>{@link org.eclipse.rcptt.tesla.ecl.model.impl.UncheckImpl#getControl <em>Control</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UncheckImpl extends CommandImpl implements Uncheck {
	...
	protected EClass eStaticClass() {
		return TeslaPackage.Literals.UNCHECK;
	}
		...
		if (control != null && control.eIsProxy()) {
			...
			if (control != oldControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TeslaPackage.UNCHECK__CONTROL, oldControl, control));
			}
		}
		return control;
	}
	...
	public void setControl(ControlHandler newControl) {
		...
		control = newControl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.UNCHECK__CONTROL, oldControl, control));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TeslaPackage.UNCHECK__CONTROL:
