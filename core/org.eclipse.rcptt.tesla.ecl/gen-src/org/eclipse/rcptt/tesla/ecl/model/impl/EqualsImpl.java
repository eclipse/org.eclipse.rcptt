 ...
 * @generated
 */
public class EqualsImpl extends CommandImpl implements Equals {
	/**
	...
	protected EClass eStaticClass() {
		return TeslaPackage.Literals.EQUALS;
	}
		...
		if (input != null && input.eIsProxy()) {
			...
			if (input != oldInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TeslaPackage.EQUALS__INPUT, oldInput, input));
			}
		}
		return input;
	}
	...
	public void setInput(EObject newInput) {
		...
		input = newInput;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.EQUALS__INPUT, oldInput, input));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.EQUALS__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TeslaPackage.EQUALS__INPUT:
				if (resolve) return getInput();
				return basicGetInput();
			case TeslaPackage.EQUALS__VALUE:
				return getValue();
		}
