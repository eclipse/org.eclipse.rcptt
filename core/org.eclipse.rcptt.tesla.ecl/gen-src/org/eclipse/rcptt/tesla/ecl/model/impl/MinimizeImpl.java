 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.rcptt.tesla.ecl.model.impl.MinimizeImpl#getControl <em>Control</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MinimizeImpl extends CommandImpl implements Minimize {
	/**
	...
	protected EClass eStaticClass() {
		return TeslaPackage.Literals.MINIMIZE;
	}
		...
		if (control != null && control.eIsProxy()) {
			...
			if (control != oldControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TeslaPackage.MINIMIZE__CONTROL, oldControl, control));
			}
		}
		return control;
	}
	...
	public void setControl(ControlHandler newControl) {
		...
		control = newControl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.MINIMIZE__CONTROL, oldControl, control));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TeslaPackage.MINIMIZE__CONTROL:
