 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.rcptt.tesla.ecl.model.impl.IsDisposedImpl#getControl <em>Control</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IsDisposedImpl extends CommandImpl implements IsDisposed {
	/**
	...
	protected EClass eStaticClass() {
		return TeslaPackage.Literals.IS_DISPOSED;
	}
		...
		if (control != null && control.eIsProxy()) {
			...
			if (control != oldControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TeslaPackage.IS_DISPOSED__CONTROL, oldControl, control));
			}
		}
		return control;
	}
	...
	public void setControl(ControlHandler newControl) {
		...
		control = newControl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.IS_DISPOSED__CONTROL, oldControl, control));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TeslaPackage.IS_DISPOSED__CONTROL:
