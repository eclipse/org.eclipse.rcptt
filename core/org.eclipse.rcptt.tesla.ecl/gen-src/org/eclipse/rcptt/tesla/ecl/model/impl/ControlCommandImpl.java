 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.rcptt.tesla.ecl.model.impl.ControlCommandImpl#getControl <em>Control</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ControlCommandImpl extends CommandImpl implements ControlCommand {
	/**
	...
	protected EClass eStaticClass() {
		return TeslaPackage.Literals.CONTROL_COMMAND;
	}
		...
		if (control != null && control.eIsProxy()) {
			...
			if (control != oldControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TeslaPackage.CONTROL_COMMAND__CONTROL, oldControl, control));
			}
		}
		return control;
	}
	...
	public void setControl(ControlHandler newControl) {
		...
		control = newControl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.CONTROL_COMMAND__CONTROL, oldControl, control));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TeslaPackage.CONTROL_COMMAND__CONTROL:
