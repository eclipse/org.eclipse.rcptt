 ...
 * @generated
 */
public class RestoreImpl extends CommandImpl implements Restore {
	/**
	...
	protected EClass eStaticClass() {
		return TeslaPackage.Literals.RESTORE;
	}
		...
		if (control != null && control.eIsProxy()) {
			...
			if (control != oldControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TeslaPackage.RESTORE__CONTROL, oldControl, control));
			}
		}
		return control;
	}
	...
	public void setControl(ControlHandler newControl) {
		...
		control = newControl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.RESTORE__CONTROL, oldControl, control));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TeslaPackage.RESTORE__CONTROL:
