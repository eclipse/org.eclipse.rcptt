...
public class HoverTextImpl extends CommandImpl implements HoverText {
		...
		if (control != null && control.eIsProxy()) {
			...
			if (control != oldControl) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TeslaPackage.HOVER_TEXT__CONTROL, oldControl, control));
			}
		}
		return control;
	}
	...
	public void setControl(ControlHandler newControl) {
		...
		control = newControl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.HOVER_TEXT__CONTROL, oldControl, control));
	}
	...
	public void setLine(int newLine) {
		...
		line = newLine;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.HOVER_TEXT__LINE, oldLine, line));
	}
	...
	public void setColumn(int newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.HOVER_TEXT__COLUMN, oldColumn, column));
	}
	...
	public void setWith(String newWith) {
		...
		with = newWith;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TeslaPackage.HOVER_TEXT__WITH, oldWith, with));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TeslaPackage.HOVER_TEXT__CONTROL:
				if (resolve) return getControl();
				return basicGetControl();
			case TeslaPackage.HOVER_TEXT__LINE:
				return getLine();
			case TeslaPackage.HOVER_TEXT__COLUMN:
				return getColumn();
			case TeslaPackage.HOVER_TEXT__WITH:
				return getWith();
		}
