...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Report Append</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ReportAppendImpl extends CommandImpl implements ReportAppend {
	...
	public EList<EObject> getObjects() {
		if (objects == null) {
			objects = new EObjectResolvingEList<EObject>(EObject.class, this, Q7CorePackage.REPORT_APPEND__OBJECTS);
		}
		return objects;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Q7CorePackage.REPORT_APPEND__OBJECTS:
				return getObjects();
		}
