...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>View List</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class ViewListImpl extends EObjectImpl implements ViewList {
	/**
	...
	protected EClass eStaticClass() {
		return Q7CorePackage.Literals.VIEW_LIST;
	}
	...
	public EList<ViewInfo> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<ViewInfo>(ViewInfo.class, this, Q7CorePackage.VIEW_LIST__ITEMS);
		}
		return items;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Q7CorePackage.VIEW_LIST__ITEMS:
