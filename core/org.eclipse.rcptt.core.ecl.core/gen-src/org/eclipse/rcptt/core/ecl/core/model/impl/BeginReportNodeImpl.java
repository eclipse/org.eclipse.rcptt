...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Begin Report Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class BeginReportNodeImpl extends CommandImpl implements BeginReportNode {
	/**
	...
	protected EClass eStaticClass() {
		return Q7CorePackage.Literals.BEGIN_REPORT_NODE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Q7CorePackage.BEGIN_REPORT_NODE__NAME, oldName, name));
	}
	...
	public EMap<String, EObject> getProperties() {
		if (properties == null) {
			properties = new EcoreEMap<String,EObject>(ReportPackage.Literals.PROPERTY_MAP, PropertyMapImpl.class, this, Q7CorePackage.BEGIN_REPORT_NODE__PROPERTIES);
		}
		return properties;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Q7CorePackage.BEGIN_REPORT_NODE__PROPERTIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Q7CorePackage.BEGIN_REPORT_NODE__NAME:
				return getName();
			case Q7CorePackage.BEGIN_REPORT_NODE__PROPERTIES:
