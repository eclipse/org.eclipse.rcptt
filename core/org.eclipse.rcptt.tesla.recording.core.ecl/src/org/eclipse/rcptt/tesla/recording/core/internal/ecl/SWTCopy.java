...
/**
 * This class provides access to a small number of SWT system-wide methods, and
 * in addition defines the public constants provided by SWT.
 * <p>
 ...
 * appearance related aspects of widgets which are available either only on some
 * window systems, or for a differing set of widgets on each window system.
 * These constants are marked as <em>HINT</em>s. The set of widgets which
 * support a particular <em>HINT</em> may change from release to release,
...
public class SWTCopy {
	 ...
	 * <p>
	 * The settings changed event is sent when an operating system property,
	 * such as a system font or color, has been changed. The event occurs after
	 * the property has been changed, but before any widget is redrawn.
	 * Applications that cache operating system properties can use this event to
	 * update their caches. A specific property change can be detected by
	 * querying the new value of a property and comparing it with the equivalent
	 ...
	 * <p>
	 * <ul>
	 * <li>{@link SWTCopy#COMPOSITION_CHANGED}</li>
	 * <li>{@link SWTCopy#COMPOSITION_OFFSET}</li>
	 ...
	 * <p>
	 * On some platforms the orientation of text widgets can be changed by
	...
	/**
	 * The IME composition event detail that indicates a change in the IME
	 * composition. The text field of the event is the new composition text. The
	...
	/**
	 * Traversal event detail field value indicating that the key which
	 * activates the default button in a dialog was pressed; typically, this is
	 * the ENTER key (value is 1&lt;&lt;2).
	 */
	 ...
	 * pressed; typically, this is the SHIFT-TAB key sequence (value is
	 * 1&lt;&lt;3).
	 */
	 ...
	 * was pressed; typically, this is the CTRL-PAGEUP key sequence (value is
	 * 1&lt;&lt;8).
	 */
	 ...
	 * pressed; typically, this is the CTRL-PAGEDOWN key sequence (value is
	 * 1&lt;&lt;9).
	 */
	...
	/**
	 * A constant known to be zero (0), used in operations which take pointers
	 * to indicate a null argument.
	 */
	...
	/**
	 * Style constant for simple (not drop down) behavior (value is 1&lt;&lt;6). <br>
	...
	/**
	 * Style constant for shadow in behavior (value is 1&lt;&lt;2). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for shadow out behavior (value is 1&lt;&lt;3). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for shadow etched in behavior (value is 1&lt;&lt;4). <br>
	 * Note that this is a <em>HINT</em>. It is ignored on all platforms except
	 * Motif.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for shadow etched out behavior (value is 1&lt;&lt;6). <br>
	 * Note that this is a <em>HINT</em>. It is ignored on all platforms except
	 * Motif.
	 * <p>
	 * <b>Used By:</b>
	...
	/**
	 * Style constant for no shadow behavior (value is 1&lt;&lt;5). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	 ...
	 * <p>
	 * A tool window is a window intended to be used as a floating toolbar. It
	 * typically has a title bar that is shorter than a normal title bar, and
	 * the window title is typically drawn using a smaller font. <br>
	 * Note that this is a <em>HINT</em>.
	 * </p>
	 * <p>
	 * <b>Used By:</b>
	...
	/**
	 * Style constant to ensure no trimmings are used (value is 1&lt;&lt;3). <br>
	...
	/**
	 * Style constant for shell menu trim (value is 1&lt;&lt;6, since we do not
	 * distinguish between CLOSE style and MENU style).
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for bordered behavior (value is 1&lt;&lt;11). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant indicating that the window manager should clip a widget's
	 * children with respect to its viewable area. (value is 1&lt;&lt;12). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant indicating that the window manager should clip a widget's
	 * siblings with respect to its viewable area. (value is 1&lt;&lt;13). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for always on top behavior (value is 1&lt;&lt;14). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	 ...
	 * general look of a sheet window is platform specific. For example, on the
	 * Macintosh, at the time this documentation was written, the window title
	 * is not visible. <br>
	 * Note that this is a <em>HINT</em>.
	 * </p>
	 * <p>
	...
	/**
	 * Style constant for modeless behavior (value is 0). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for primary modal behavior (value is 1&lt;&lt;15). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for application modal behavior (value is 1&lt;&lt;16). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for system modal behavior (value is 1&lt;&lt;17). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	 ...
	 * indicating that a full line should be drawn. (value is 1&lt;&lt;16). <br>
	 * Note that for some widgets this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	 * <li><code>Table</code></li>
	...
	/**
	 * Style constant for flat appearance. (value is 1&lt;&lt;23). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for smooth appearance. (value is 1&lt;&lt;16). <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for no focus from the mouse behavior (value is
	 * 1&lt;&lt;19).
	 * <p>
	 ...
	 * size of the Canvas changes. Specifically, when the size of the Canvas
	...
	/**
	 * Style constant for preventing child radio group behavior (value is
	 * 1&lt;&lt;22).
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	 ...
	 * By default, before a widget paints, the client area is filled with the
	 * current background. When this style is specified, the background is not
	 * filled and widgets that are obscured will draw through.
	 * </p>
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for align up behavior (value is 1&lt;&lt;7, since align UP
	 * and align TOP are considered the same).
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant for align top behavior (value is 1&lt;&lt;7, since align
	...
	/**
	 * Style constant for align left behavior (value is 1&lt;&lt;14). This is a
	 * synonym for {@link #LEAD} (value is 1&lt;&lt;14). Newer applications
	 * should use {@link #LEAD} instead of {@link #LEFT} to make code more
	 * understandable on right-to-left platforms.
	 * <p>
	 * This constant can also be used to representing the left keyboard location
	 * during a key event.
	 * </p>
	 */
	 ...
	 * synonym for {@link #TRAIL} (value is 1&lt;&lt;17). Newer applications
	 * should use {@link #TRAIL} instead of {@link #RIGHT} to make code more
	 * understandable on right-to-left platforms.
	 * <p>
	 ...
	 * <p>
	 * A short date displays the month and year. A short time displays hours and
	 * minutes. <br>
	 * Note that this is a <em>HINT</em>.
	 * </p>
	 * <p>
	 ...
	 * <p>
	 * A medium date displays the day, month and year. A medium time displays
	 ...
	 * <p>
	 * A long date displays the day, month and year. A long time displays hours,
	 * minutes, and seconds. The day and month names may be displayed. <br>
	 * Note that this is a <em>HINT</em>.
	 * </p>
	 * <p>
	 * <b>Used By:</b>
	...
	/**
	 * Style constant specifying that a Browser should use a Mozilla GRE for
	 * rendering its content (value is 1&lt;&lt;15).
	 * <p>
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Style constant specifying that a Browser should use WebKit for rendering
	 * its content (value is 1&lt;&lt;16).
	 * <p>
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * Input Method Editor style constant for double byte input behavior (value
	 * is 1&lt;&lt;1).
	 */
	public static final int DBCS = 1 << 1;

	/**
	 * Input Method Editor style constant for alpha input behavior (value is
	 * 1&lt;&lt;2).
	 */
	...
	/**
	 * Input Method Editor style constant for phonetic input behavior (value is
	 * 1&lt;&lt;4).
	 */
	public static final int PHONETIC = 1 << 4;

	/**
	 * Input Method Editor style constant for romanicized input behavior (value
	 * is 1&lt;&lt;5).
	 */
	public static final int ROMAN = 1 << 5;

	/**
	 * ASCII character convenience constant for the backspace character (value
	 * is the <code>char</code> '\b').
	 */
	...
	/**
	 * ASCII character convenience constant for the delete character (value is
	 * the <code>char</code> with value 127).
	 */
	public static final char DEL = 0x7F;

	/**
	 * ASCII character convenience constant for the escape character (value is
	 * the <code>char</code> with value 27).
	 */
	public static final char ESC = 0x1B;

	/**
	 * ASCII character convenience constant for the line feed character (value
	 * is the <code>char</code> '\n').
	 */
	...
	/**
	 * keyboard and/or mouse event mask indicating that the ALT key was pushed
	 * on the keyboard when the event was generated (value is 1&lt;&lt;16).
	 */
	public static final int ALT = 1 << 16;

	/**
	 * Keyboard and/or mouse event mask indicating that the SHIFT key was pushed
	 * on the keyboard when the event was generated (value is 1&lt;&lt;17).
	 */
	...
	/**
	 * Keyboard and/or mouse event mask indicating that the CTRL key was pushed
	 * on the keyboard when the event was generated. This is a synonym for CTRL
	 * (value is 1&lt;&lt;18).
	 */
	...
	/**
	 * Keyboard and/or mouse event mask indicating that mouse button one was
	 * pushed when the event was generated. (value is 1&lt;&lt;19).
	 */
	public static final int BUTTON1 = 1 << 19;

	/**
	 * Keyboard and/or mouse event mask indicating that mouse button two was
	 * pushed when the event was generated. (value is 1&lt;&lt;20).
	 */
	public static final int BUTTON2 = 1 << 20;

	/**
	 * Keyboard and/or mouse event mask indicating that mouse button three was
	 * pushed when the event was generated. (value is 1&lt;&lt;21).
	 */
	...
	/**
	 * Keyboard event constant representing the UP ARROW key (value is
	 * (1&lt;&lt;24)+1).
	 */
	public static final int ARROW_UP = KEYCODE_BIT + 1;

	/**
	 * Keyboard event constant representing the DOWN ARROW key (value is
	 * (1&lt;&lt;24)+2).
	 */
	public static final int ARROW_DOWN = KEYCODE_BIT + 2;

	/**
	 * Keyboard event constant representing the LEFT ARROW key (value is
	 * (1&lt;&lt;24)+3).
	 */
	public static final int ARROW_LEFT = KEYCODE_BIT + 3;

	/**
	 * Keyboard event constant representing the RIGHT ARROW key (value is
	 * (1&lt;&lt;24)+4).
	 */
	public static final int ARROW_RIGHT = KEYCODE_BIT + 4;

	/**
	 * Keyboard event constant representing the PAGE UP key (value is
	 * (1&lt;&lt;24)+5).
	 */
	public static final int PAGE_UP = KEYCODE_BIT + 5;

	/**
	 * Keyboard event constant representing the PAGE DOWN key (value is
	 * (1&lt;&lt;24)+6).
	 */
	public static final int PAGE_DOWN = KEYCODE_BIT + 6;

	/**
	 * Keyboard event constant representing the HOME key (value is
	 * (1&lt;&lt;24)+7).
	 */
	public static final int HOME = KEYCODE_BIT + 7;

	/**
	 * Keyboard event constant representing the END key (value is
	 * (1&lt;&lt;24)+8).
	 */
	public static final int END = KEYCODE_BIT + 8;

	/**
	 * Keyboard event constant representing the INSERT key (value is
	 * (1&lt;&lt;24)+9).
	 */
	public static final int INSERT = KEYCODE_BIT + 9;

	/**
	 * Keyboard event constant representing the F1 key (value is
	 * (1&lt;&lt;24)+10).
	 */
	public static final int F1 = KEYCODE_BIT + 10;

	/**
	 * Keyboard event constant representing the F2 key (value is
	 * (1&lt;&lt;24)+11).
	 */
	public static final int F2 = KEYCODE_BIT + 11;

	/**
	 * Keyboard event constant representing the F3 key (value is
	 * (1&lt;&lt;24)+12).
	 */
	public static final int F3 = KEYCODE_BIT + 12;

	/**
	 * Keyboard event constant representing the F4 key (value is
	 * (1&lt;&lt;24)+13).
	 */
	public static final int F4 = KEYCODE_BIT + 13;

	/**
	 * Keyboard event constant representing the F5 key (value is
	 * (1&lt;&lt;24)+14).
	 */
	public static final int F5 = KEYCODE_BIT + 14;

	/**
	 * Keyboard event constant representing the F6 key (value is
	 * (1&lt;&lt;24)+15).
	 */
	public static final int F6 = KEYCODE_BIT + 15;

	/**
	 * Keyboard event constant representing the F7 key (value is
	 * (1&lt;&lt;24)+16).
	 */
	public static final int F7 = KEYCODE_BIT + 16;

	/**
	 * Keyboard event constant representing the F8 key (value is
	 * (1&lt;&lt;24)+17).
	 */
	public static final int F8 = KEYCODE_BIT + 17;

	/**
	 * Keyboard event constant representing the F9 key (value is
	 * (1&lt;&lt;24)+18).
	 */
	public static final int F9 = KEYCODE_BIT + 18;

	/**
	 * Keyboard event constant representing the F10 key (value is
	 * (1&lt;&lt;24)+19).
	 */
	public static final int F10 = KEYCODE_BIT + 19;

	/**
	 * Keyboard event constant representing the F11 key (value is
	 * (1&lt;&lt;24)+20).
	 */
	public static final int F11 = KEYCODE_BIT + 20;

	/**
	 * Keyboard event constant representing the F12 key (value is
	 * (1&lt;&lt;24)+21).
	 */
	...
	/**
	 * The <code>MessageBox</code> style constant for "working" icon behavior
	 * (value is 1&lt;&lt;4).
	 */
	public static final int ICON_WORKING = 1 << 4;

	/**
	 * The style constant for "search" icon. This style constant is used with
	...
	/**
	 * The style constant for "cancel" icon. This style constant is used with
	 * <code>Text</code> in combination with <code>SWT.SEARCH
	...
	/**
	 * The <code>MessageBox</code> style constant for an OK button; valid
	 * combinations are OK, OK|CANCEL (value is 1&lt;&lt;5).
	 */
	public static final int OK = 1 << 5;

	/**
	 * The <code>MessageBox</code> style constant for YES button; valid
	 * combinations are YES|NO, YES|NO|CANCEL (value is 1&lt;&lt;6).
	 */
	public static final int YES = 1 << 6;

	/**
	 * The <code>MessageBox</code> style constant for NO button; valid
	 * combinations are YES|NO, YES|NO|CANCEL (value is 1&lt;&lt;7).
	 */
	...
	/**
	 * The <code>MessageBox</code> style constant for an ABORT button; the only
	 * valid combination is ABORT|RETRY|IGNORE (value is 1&lt;&lt;9).
	 */
	public static final int ABORT = 1 << 9;

	/**
	 * The <code>MessageBox</code> style constant for a RETRY button; valid
	 * combinations are ABORT|RETRY|IGNORE, RETRY|CANCEL (value is 1&lt;&lt;10).
	 */
	public static final int RETRY = 1 << 10;

	/**
	 * The <code>MessageBox</code> style constant for an IGNORE button; the only
	 * valid combination is ABORT|RETRY|IGNORE (value is 1&lt;&lt;11).
	 */
	...
	/**
	 * The <code>Composite</code> constant to indicate that an attribute (such
	 * as background) is inherited by children who choose this value as their
	...
	/**
	 * System color used to paint inactive title background gradient (value is
	 * 35).
	 */
	public static final int COLOR_TITLE_INACTIVE_BACKGROUND_GRADIENT = 35;

	/**
	 * Draw constant indicating whether the drawing operation should fill the
	 * background (value is 1&lt;&lt;0).
	 */
	public static final int DRAW_TRANSPARENT = 1 << 0;

	/**
	 * Draw constant indicating whether the string drawing operation should
	 * handle line-delimiters (value is 1&lt;&lt;1).
	 */
	public static final int DRAW_DELIMITER = 1 << 1;

	/**
	 * Draw constant indicating whether the string drawing operation should
	 * expand TAB characters (value is 1&lt;&lt;2).
	 */
	...
	/**
	 * SWT error constant indicating that no error number was specified (value
	 * is 1).
	 */
	public static final int ERROR_UNSPECIFIED = 1;

	/**
	 * SWT error constant indicating that no more handles for an operating
	 * system resource are available (value is 2).
	 */
	public static final int ERROR_NO_HANDLES = 2;

	/**
	 * SWT error constant indicating that no more callback resources are
	 * available (value is 3).
	 */
	public static final int ERROR_NO_MORE_CALLBACKS = 3;

	/**
	 * SWT error constant indicating that a null argument was passed in (value
	 * is 4).
	 */
	...
	/**
	 * SWT error constant indicating that a value was found to be outside the
	 * allowable range (value is 6).
	 */
	...
	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to provide the value of an item (value is 8).
	 */
	public static final int ERROR_CANNOT_GET_ITEM = 8;

	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to provide the selection (value is 9).
	 */
	...
	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to provide the height of an item (value is 11).
	 */
	public static final int ERROR_CANNOT_GET_ITEM_HEIGHT = 11;

	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to provide the text of a widget (value is 12).
	 */
	public static final int ERROR_CANNOT_GET_TEXT = 12;

	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to set the text of a widget (value is 13).
	 */
	public static final int ERROR_CANNOT_SET_TEXT = 13;

	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to add an item (value is 14).
	 */
	public static final int ERROR_ITEM_NOT_ADDED = 14;

	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to remove an item (value is 15).
	 */
	public static final int ERROR_ITEM_NOT_REMOVED = 15;

	/**
	 * SWT error constant indicating that the graphics library is not available
	 * (value is 16).
	 */
	...
	/**
	 * SWT error constant indicating that a menu which needed to have the drop
	 * down style had some other style instead (value is 21).
	 */
	...
	/**
	 * SWT error constant indicating that a menu item which needed to have the
	 * cascade style had some other style instead (value is 27).
	 */
	public static final int ERROR_MENUITEM_NOT_CASCADE = 27;

	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to set the selection of a widget (value is 28).
	 */
	public static final int ERROR_CANNOT_SET_SELECTION = 28;

	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to set the menu (value is 29).
	 */
	public static final int ERROR_CANNOT_SET_MENU = 29;

	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to set the enabled state (value is 30).
	 */
	public static final int ERROR_CANNOT_SET_ENABLED = 30;

	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to provide enabled/disabled state information (value is 31).
	 */
	...
	/**
	 * SWT error constant indicating that a menu which needed to have the menu
	 * bar style had some other style instead (value is 33).
	 */
	public static final int ERROR_MENU_NOT_BAR = 33;

	/**
	 * SWT error constant indicating that the underlying operating system was
	 * unable to provide count information (value is 36).
	 */
	public static final int ERROR_CANNOT_GET_COUNT = 36;

	/**
	 * SWT error constant indicating that a menu which needed to have the pop up
	 * menu style had some other style instead (value is 37).
	 */
	public static final int ERROR_MENU_NOT_POP_UP = 37;

	/**
	 * SWT error constant indicating that a graphics operation was attempted
	 * with an image of an unsupported depth (value is 38).
	 */
	public static final int ERROR_UNSUPPORTED_DEPTH = 38;

	/**
	 * SWT error constant indicating that an input/output operation failed
	 * during the execution of an SWT operation (value is 39).
	 */
	public static final int ERROR_IO = 39;

	/**
	 * SWT error constant indicating that a graphics operation was attempted
	 * with an image having an invalid format (value is 40).
	 */
	public static final int ERROR_INVALID_IMAGE = 40;

	/**
	 * SWT error constant indicating that a graphics operation was attempted
	 * with an image having a valid but unsupported format (value is 42).
	 */
	...
	/**
	 * Constant indicating that an image or operation is of type bitmap (value
	 * is 0).
	 */
	public static final int BITMAP = 0;

	/**
	 * Constant indicating that an image or operation is of type icon (value is
	 * 1).
	 */
	 ...
	 * should be a copy of the image provided as an argument (value is 0).
	 */
	...
	/**
	 * GIF image disposal method constants indicating that the disposal method
	 * is unspecified (value is 0).
	 */
	public static final int DM_UNSPECIFIED = 0x0;

	/**
	 * GIF image disposal method constants indicating that the disposal method
	 * is to do nothing; that is, to leave the previous image in place (value is
	 * 1).
	 */
	public static final int DM_FILL_NONE = 0x1;

	/**
	 * GIF image disposal method constants indicating that the the previous
	 * images should be covered with the background color before displaying the
	 * next image (value is 2).
	 */
	public static final int DM_FILL_BACKGROUND = 0x2;

	/**
	 * GIF image disposal method constants indicating that the disposal method
	 * is to restore the previous picture (value is 3).
	 */
	public static final int DM_FILL_PREVIOUS = 0x3;

	/**
	 * Image transparency constant indicating that the image contains no
	 * transparency information (value is 0).
	 */
	public static final int TRANSPARENCY_NONE = 0x0;

	/**
	 * Image transparency constant indicating that the image contains alpha
	 * transparency information (value is 1&lt;&lt;0).
	 */
	public static final int TRANSPARENCY_ALPHA = 1 << 0;

	/**
	 * Image transparency constant indicating that the image contains a
	 * transparency mask (value is 1&lt;&lt;1).
	 */
	public static final int TRANSPARENCY_MASK = 1 << 1;

	/**
	 * Image transparency constant indicating that the image contains a
	 * transparent pixel (value is 1&lt;&lt;2).
	 */
	...
	/**
	 * The word movement type (value is 1&lt;&lt;2). This constant is used to
	 * move a text offset over a word. The behavior of this constant depends on
	 * the platform and on the direction of the movement. For example, on
	...
	static {
		/*
		 * These values represent bit masks that may need to expand in the
		 * future. Therefore they are not initialized in the declaration to stop
