...
public class ImageImpl extends EObjectImpl implements Image {
	 ...
	 * @ordered
	 */
	protected EList<Image> decorations;
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiPackage.IMAGE__PATH, oldPath, path));
	}
	 ...
	 * @generated
	 */
	public EList<Image> getDecorations() {
		if (decorations == null) {
			decorations = new EObjectContainmentEList<Image>(Image.class, this, UiPackage.IMAGE__DECORATIONS);
		}
		return decorations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UiPackage.IMAGE__DECORATIONS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UiPackage.IMAGE__DECORATIONS:
				...
				getDecorations().addAll((Collection<? extends Image>)newValue);
				return;
		}
