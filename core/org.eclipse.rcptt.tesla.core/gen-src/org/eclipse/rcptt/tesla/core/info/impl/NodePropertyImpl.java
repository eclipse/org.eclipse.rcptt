 ...
 * @generated
 */
public class NodePropertyImpl extends EObjectImpl implements NodeProperty {
	/**
	...
	protected EClass eStaticClass() {
		return InfoPackage.Literals.NODE_PROPERTY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfoPackage.NODE_PROPERTY__NAME, oldName, name));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InfoPackage.NODE_PROPERTY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InfoPackage.NODE_PROPERTY__NAME:
				return getName();
			case InfoPackage.NODE_PROPERTY__VALUE:
				return getValue();
		}
