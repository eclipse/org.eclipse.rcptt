 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.rcptt.tesla.core.ui.impl.SelectionImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelectionImpl extends EObjectImpl implements Selection {
	...
	protected EClass eStaticClass() {
		return UiPackage.Literals.SELECTION;
	}
	...
	public EList<String> getPath() {
		if (path == null) {
			path = new EDataTypeEList<String>(String.class, this, UiPackage.SELECTION__PATH);
		}
		return path;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UiPackage.SELECTION__PATH:
				return getPath();
		}
