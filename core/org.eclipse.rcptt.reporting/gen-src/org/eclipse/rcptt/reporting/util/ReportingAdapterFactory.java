...
public class ReportingAdapterFactory extends AdapterFactoryImpl {
	...
	protected ReportingSwitch<Adapter> modelSwitch =
		new ReportingSwitch<Adapter>() {
			@Override
			public Adapter caseQ7Info(Q7Info object) {
				return createQ7InfoAdapter();
			}
			@Override
			public Adapter caseQ7Statistics(Q7Statistics object) {
				return createQ7StatisticsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.rcptt.reporting.Q7Info <em>Q7 Info</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.rcptt.reporting.Q7Statistics <em>Q7 Statistics</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
